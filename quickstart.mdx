---
title: 'Quickstart'
description: 'Get started with InferX in minutes'
---
...
**📊 [View Model & Platform Compatibility Matrix](https://github.com/exla-ai/InferX?tab=readme-ov-file#-model--platform-compatibility-matrix)**
...
- Learn about [hardware compatibility](https://github.com/exla-ai/InferX?tab=readme-ov-file#-model--platform-compatibility-matrix) for optimized performance
...
- Explore [hardware-specific optimizations](https://github.com/exla-ai/InferX?tab=readme-ov-file#-model--platform-compatibility-matrix)
